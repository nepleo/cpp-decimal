...
package com.example.decimal.javamath;
...
// Avoid dependencies on jdk.internal.* packages (not accessible to normal apps).
// These stand-ins mirror the relevant JDK constants/annotations used in BigInteger.
final class FloatConsts {
    static final int SIGNIFICAND_WIDTH = 24;
    static final int EXP_BIAS = 127;
    static final int SIGNIF_BIT_MASK = 0x007fffff;
    static final int SIGN_BIT_MASK = 0x80000000;

    private FloatConsts() {}
}

final class DoubleConsts {
